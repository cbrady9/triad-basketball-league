...
const TEAMSTATS_GID = '1640890982'; // GID for the 'Team Stats (AUTOMATED)' tab
...
const TEAMSTATS_QUERY = 'SELECT A, B, P, Q, R, S, T, U, V, W, X, Y'; // Adjust as needed!
...
function renderTeamStatsTable(tableData) {
