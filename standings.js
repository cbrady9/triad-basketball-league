...
const STANDINGS_GID = '770406970'; // GID for the 'Team Standings (AUTOMATED)' tab

// The Google Visualization API query.
// 'SELECT A, B, C, D' means select columns A, B, C, and D.
// Adjust these column letters based on where your data is in the 'Team Standings (AUTOMATED)' sheet.
// For example, if 'Team Name' is in column A, 'Wins' in B, 'Losses' in C, 'Point Differential' in D.
const STANDINGS_QUERY = 'SELECT A, B, C, D, E, F'; // Adjust as needed!
