document.addEventListener('DOMContentLoaded', () => {
    ...
    const RULES_CONTENT = {
        "S01": `
        <div class="space-y-4">
            <h2 class="text-3xl font-bold text-gray-100">Season 1 Rules</h2>
            <p class="text-lg text-gray-400 !mt-2">
                All rules can be modified by a "gentleman's agreement" between both teams before the game begins. If no agreement is made, these official guidelines apply.
            </p>
        </div>
        
        <div class="prose prose-invert max-w-none text-gray-300 mt-8 space-y-6">
            
            <div>
                <h3 class="text-xl font-semibold text-gray-200">Scoring & Game Flow</h3>
            ...
            <div>
                <h3 class="text-xl font-semibold text-gray-200">Clearing the Ball</h3>
                <ul class="mt-2 space-y-1">
                    <li>After a defensive rebound where the shot <strong>hits the rim</strong>, the ball must be taken back (cleared) behind the two-point line.</li>
                    <li>On a defensive rebound where the shot <strong>does not hit the rim</strong> (an "airball"), the ball does not need to be cleared and can be scored immediately.</li>
                </ul>
            </div>

            <div>
                <h3 class="text-xl font-semibold text-gray-200">Fouls & Disputes</h3>
                <ul class="mt-2 space-y-1">
